...
class ReportGenerator:
    ...
    def generate_admin_master_report(self, audit_data: Dict[str, Any], scan_data: Dict[str, Any]) -> Dict[str, Any]:
        """Create the V7.5.2 evidence-first, outcome-guided, Architect-escalated master report.
        ...
        return {
            "report_type": "ADMIN_LEAD_ALERT_V7_5_2",
...
<main style="max-width:920px;margin:0 auto;background:#FCFBF8;padding:32px 24px 60px;">
  <div style="font:700 11px Inter,sans-serif;color:#9A7A31;letter-spacing:1.5px;text-transform:uppercase;">TRILLOKA TELEMETRY & EXECUTIVE AUDIT — V7.5.2</div>
